...
public final class FrmMain extends javax.swing.JFrame {
    ...
    public FrmMain() {
        ...
        btnAudit.setMargin(new Insets(0, 0, 0, 0));
    ...
    private void initComponents() {
        ...
        btnUsers.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/profile/img/rsz_add_users_plus_group-512.png"))); // NOI18N
        ...
        btnAudit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/profile/img/rsz_icon-audit-trail.png"))); // NOI18N
        ...
        pnlButtonLayout.setHorizontalGroup(
            ...
            .addGroup(pnlButtonLayout.createSequentialGroup()
                ...
                .addGap(65, 65, 65)
                .addGroup(pnlButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnAudit, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnlButtonLayout.setVerticalGroup(
            ...
            .addGroup(pnlButtonLayout.createSequentialGroup()
                .addGroup(pnlButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlButtonLayout.createSequentialGroup()
                        .addGroup(pnlButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnAudit, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                        ...
                        .addGroup(pnlButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        jLabel54.setText("After Clicking the data you can either delete, reset and update the information.");
        ...
        jLabel71.setText("Clicking the data in the table will automatically load the different information of the entity.");

        jLabel73.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/profile/img/icons8-4-60.png"))); // NOI18N

        jLabel74.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 18)); // NOI18N
        jLabel74.setText("In the Log Activity, you can find the different action committed in the system.");

        jLabel75.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/profile/img/icons8-5-60.png"))); // NOI18N
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        try {
            ...
            if (response == 0) {
                Object[] values = {firstname, lastname, MI, email, genderPatient, username, password, position, image};
                ...
                if (PG.executeDML(query, values)) {
                  JOptionPane.showMessageDialog(null, username + " has been created");
                    ...
                    String status = "Inserted the field "+firstname+","+lastname+","+MI+","+email+","+genderPatient+","+username+","+password+","+position+" Into Personnel";
                    Object[] values1 = {value1,value0,status,value};
                    String query1 = "INSERT INTO Audit(dateaudit,timeaudit,status,u_id) VALUES (?,?,?,?)";
                    PG.executeDML(query1, values1); 
...
//            lblIMAGE.setIcon(new javax.swing.ImageIcon(scaledImage));  
    ...
    private void btnUpdatePatientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdatePatientActionPerformed
        ...
        if (rdoBtnMALE.isSelected()) {
            ...
            int reply = javax.swing.JOptionPane.showConfirmDialog(null, "Do you wish to update this account?", "UPDATE", JOptionPane.YES_NO_OPTION);
            if(reply == 0){
                Object[] values = {firstname,lastname, MI, age, genderPatient, contact,bdate,address,occupation,philno,attendant,service_avail,diagnosis,id};
                String query = "UPDATE Patient SET p_fname=?, p_lname=?, p_MI=?, p_age=?, p_gender=?, p_contact=?, p_birthdate=?, p_address=?, p_occupation=?, philhealthno=?, attendant=?, service_avail=?, diagnosis=? WHERE p_id=?";
                if(PG.executeDML(query, values)){
                 ...
                 Date currentDate = GregorianCalendar.getInstance().getTime();
                    ...
                    String value1 = dateString;
                    int value = FrmLogin.pid;
                    String status = "Updated the field "+firstname+","+lastname+","+MI+","+age+","+genderPatient+","+contact+","+bdate+","+address+","+occupation+","+philno+","+attendant+","+service_avail+","+diagnosis+" Into Patient";
                    Object[] values1 = {value1,value0,status,value};
                    String query1 = "INSERT INTO Audit(dateaudit,timeaudit,status,u_id) VALUES (?,?,?,?)";
                    PG.executeDML(query1, values1);
            }else{
